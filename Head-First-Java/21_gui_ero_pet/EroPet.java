...
public class EroPet
{
    ...
    public void go()
    {
        ...
        BraListener braListener = new BraListener(this);
        NackedListener nackedListener = new NackedListener(this);
        AssListener assListener = new AssListener(this);
        DressListener dressListener = new DressListener(this);
